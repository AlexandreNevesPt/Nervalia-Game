...
#                    CRÉDITOS (INTERFACE)
# ===============================================================
def mostrar_creditos(user=None):
    from menu_mod import menu_mod 
    """Mostra os créditos do jogo com animação e fundo."""
    root = tk.Tk()
    root.title("Créditos - A Jornada de Nervalia")
    ...
    # --- TEXTOS DOS CRÉDITOS ---
    textos = [
        "🎮✨  CRÉDITOS DO JOGO: *A Jornada de Nervalia* ✨🎮",
        "",
        "👑 Desenvolvido com coragem e criatividade por:",
        "   🧠  Alexandre Neves — Programação, História e Mecânicas",
        "   🎨  Ksenia Leoniuk — Design, Pixel Art e Estilo Visual",
        "",
        "💡 Agradecimentos especiais a todos os que acreditaram nesta aventura!",
        "",
        "🌟 Este jogo foi criado com Python puro, muita paixão e imaginação!",
        "",
        "📜 *Que a tua jornada em Nervalia seja lendária!* 🌄",
        "",
        "───────────────────────────────────────────────",
    ...
    def desenhar_creditos():
        ...
        # Container invisível p/ centralizar texto
        text_y = win_h // 5
        text_spacing = 40 * scale
    ...
    root.after(200, desenhar_creditos)
    root.mainloop()
